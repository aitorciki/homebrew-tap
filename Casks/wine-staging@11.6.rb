cask "wine-staging@11.6" do
  ...
  url "https://github.com/aitorciki/macOS_Wine_builds/releases/download/#{version}/wine-staging-#{version}-osx64.tar.xz",
      verified: "github.com/aitorciki/macOS_Wine_builds/"
  name "WineHQ-staging"
